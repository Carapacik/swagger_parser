/// Utils for handling file names, class names, etc.
class CaseUtils {
  ...
  /// Return test formatted to camel case
  ...
  /// Return test formatted to pascal case
  String get pascalCase => _words.map(_upperCaseFirstLetter).join();

  /// Return test formatted to snake case
